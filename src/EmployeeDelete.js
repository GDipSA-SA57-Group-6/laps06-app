...
export default function EmployeeDelete() {
  ...
  return (
    <div className="col-sm-8 py-2 px-5 offset-2 shadow">
      ...
      {showSuccessMessage && <p>Employee deleted successfully!</p>}
        <form>
        ...
        <br />
        <input type="boolean" name="entitlementToAnnualLeave" value={object.entitlementToAnnualLeaveElement? "Yes" : "No"} disabled/>
        <br />
        ...
        <br />
        <input type="text" name="belongToDepartment.includedBy" value={object.belongToDepartmentIncludedByElement 
                        !== null ? object.belongToDepartmentIncludedByElement : "null"} disabled/>
        <br />
